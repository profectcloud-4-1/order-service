...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    private BaseErrorCode getErrorCodeByName(String name) {
        try {
            return profect.group1.goormdotcom.common.apiPayload.code.status.ErrorStatus.valueOf(name);
        } catch (IllegalArgumentException ex) {
            return profect.group1.goormdotcom.common.apiPayload.code.status.ErrorStatus._INTERNAL_SERVER_ERROR;
        }
    }
